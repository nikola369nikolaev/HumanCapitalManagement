...
The project integrates with the [API Ninjas Working Days API](https://api-ninjas.com/api/workingdays) to retrieve the number of working days for an employee.
